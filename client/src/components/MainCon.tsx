      ...
      <section className='w-full'>
        <div className="w-full items-center justify-center my-6">
          ...
          <div className="hidden md:flex gap-3 items-center ">
            <motion.div onClick={prefseSlide} whileTap={{ scale: 0.6 }} className="w-8 bg-blue-400   hover:bg-blue-600 cursor-pointer transition-all duration-100 ease-in-out rounded-lg h-8 flex items-center justify-center"><MdChevronLeft className='text-lg text-white'/></motion.div>
            <motion.div onClick={nextSlid} whileTap={{ scale: 0.6 }} className="w-8 bg-blue-400   hover:bg-blue-600 cursor-pointer transition-all duration-100 ease-in-out rounded-lg h-8 flex items-center justify-center"><MdChevronRight className='text-lg text-white'/></motion.div>
          </div>  
        </div>
